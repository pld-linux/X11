...
Summary(es):	Programas básicos y servidores para el sistema de ventanas Xorg
Summary(fr):	Serveurs du système Xorg et programmes de base
Summary(ja):	Xorg window system ¤Î¥µ¡¼¥Ð¤È´ðËÜÅª¤Ê¥×¥í¥°¥é¥à
Summary(ko):	X¿¡ ÇÊ¿äÇÑ ±âº»ÀûÀÎ ±Û²Ã°ú ÇÁ·Î±×·¥°ú ¹®¼­µé
Summary(pl):	Xorg Window System wraz z podstawowymi programami
Summary(tr):	Xorg Pencereleme Sistemi sunucularý ve temel programlar
Summary(pt_BR):	Programas básicos e servidores para o sistema de janelas Xorg
...
Summary(zh_CN):	Xorg ´°¿ÚÏµÍ³·þÎñÆ÷ºÍ»ù±¾³ÌÐò
Name:		Xorg
Version:	6.7.0
Release:	0.1
License:	XFree86 1.0 (?)
...
ÇÒÁÆÉÞÅÓËÉÅ ÐÒÏÇÒÁÍÍÙ, ÔÅËÓÔÏ×ÙÅ ÒÅÄÁËÔÏÒÙ É Ô.Ð. Xorg - ÜÔÏ ×ÅÒÓÉÑ
...
xfs É ÂÉÂÌÉÏÔÅËÉ Xorg-libs. ÷ÏÚÍÏÖÎÏ ÐÒÉÄÅÔÓÑ ÕÓÔÁÎÏ×ÉÔØ ÔÁËÖÅ ÏÄÉÎ
ÉÌÉ ÂÏÌÅÅ ÐÁËÅÔÏ× ÛÒÉÆÔÏ× Xorg.
...
ÐÒÏÇÒÁÍÉ, ÔÅËÓÔÏ×¦ ÒÅÄÁËÔÏÒÉ ¦ Ô.¦. Xorg - ÃÅ ×ÅÒÓ¦Ñ X, ÑËÁ ÐÒÁÃÀ¤
...
Â¦ÂÌ¦ÏÔÅËÉ Xorg-libs. íÏÖÌÉ×Ï ÔÁËÏÖ ÐÒÉÊÄÅÔØÓÑ ×ÓÔÁÎÏ×ÉÔÉ ÏÄÉÎ ÁÂÏ
ÄÅË¦ÌØËÁ ÐÁËÅÔ¦× ÛÒÉÆÔ¦× Xorg.

îÕ ¦, ÎÁÒÅÛÔ¦, ÑËÝÏ ×É ÚÂÉÒÁ¤ÔÅÓØ ÒÏÚÒÏÂÌÑÔÉ ÐÒÉËÌÁÄÎ¦ ÐÒÏÇÒÁÍÉ, ÝÏ
ÐÒÁÃÀÀÔØ ÑË X-ËÌ¦¤ÎÔÉ, ×ÁÍ ÔÁËÏÖ ÔÒÅÂÁ ÂÕÄÅ ×ÓÔÁÎÏ×ÉÔÉ Xorg-devel.

%package common
Summary:	Xorg files required both on server and client side
Summary(pl):	Pliki Xorg wymagane zarówno po stronie serwera jak i klienta
Group:		X11/Xorg
...
Pliki Xorg wymagane zarówno po stronie serwera jak i klienta.
...
Summary(ru):	"÷ÌÏÖÅÎÎÙÊ" ÓÅÒ×ÅÒ Xorg
Summary(uk):	"÷ËÌÁÄÅÎÉÊ" ÓÅÒ×ÅÒ Xorg
...
Summary(ru):	óÅÒ×ÅÒ Xorg ÄÌÑ ×ÉÒÔÕÁÌØÎÏÇÏ ÆÒÅÊÍÂÕÆÅÒÁ
Summary(uk):	óÅÒ×ÅÒ Xorg ÄÌÑ ×¦ÒÔÕÁÌØÎÏÇÏ ÆÒÅÊÍÂÕÆÅÒÁ
Group:		X11/Xorg/Servers
Requires:	%{name}-common = %{epoch}:%{version}-%{release}
Requires:	/usr/X11R6/lib/X11/rgb.txt
Requires:	%{name}-modules = %{epoch}:%{version}-%{release}
...
Xorg-devel ×ËÌÀÞÁÅÔ ÂÉÂÌÉÏÔÅËÉ, ÈÅÄÅÒÁ É ÄÏËÕÍÅÎÔÁÃÉÀ, ÎÅÏÂÈÏÄÉÍÙÅ
ÄÌÑ ÒÁÚÒÁÂÏÔËÉ ÐÒÏÇÒÁÍÍ, ÒÁÂÏÔÁÀÝÉÈ ËÁË X-ËÌÉÅÎÔÙ. Xorg-devel
×ËÌÀÞÁÅÔ ÂÁÚÏ×ÕÀ ÂÉÂÌÉÏÔÅËÕ Xlib É ÎÁÂÏÒÙ ÐÒÉÍÉÔÉ×Ï× Xt É Xaw.

õÓÔÁÎÏ×ÉÔÅ Xorg-devel ÅÓÌÉ ×Ù ÓÏÂÉÒÁÅÔÅÓØ ÒÁÚÒÁÂÁÔÙ×ÁÔØ ÐÒÏÇÒÁÍÍÙ,
...
Xorg-devel Í¦ÓÔÉÔØ Â¦ÂÌ¦ÏÔÅËÉ, ÈÅÄÅÒÉ ÔÁ ÄÏËÕÍÅÎÔÁÃ¦À, ÎÅÏÂÈ¦ÄÎ¦
ÄÌÑ ÒÏÚÒÏÂËÉ ÐÒÏÇÒÁÍ, ÑË¦ ÐÒÁÃÀÀÔØ ÑË X-ËÌ¦¤ÎÔÉ. Xorg-devel Í¦ÓÔÉÔØ
ÂÁÚÏ×Õ Â¦ÂÌ¦ÏÔÅËÕ Xlib ÔÁ ÎÁÂÏÒÉ ÐÒÉÍ¦ÔÉ×¦× Xt ÔÁ Xaw.

÷ÓÔÁÎÏ×¦ÔØ Xorg-devel ÑËÝÏ ×É ÚÂÉÒÁ¤ÔÅÓØ ÒÏÚÒÏÂÌÑÔÉ ÐÒÏÇÒÁÍÉ, ÑË¦
ÂÕÄÕÔØ ÐÒÁÃÀ×ÁÔÉ ÑË X-ËÌ¦¤ÎÔÉ.

%package Xserver-devel
Summary:	Header files for Xorg Xserver drivers/extensions development
Summary(pl):	Pliki nag³ówkowe do tworzenia sterowników/rozszerzeñ X serwera Xorg
Group:		X11/Development/Libraries
Requires:	%{name}-devel = %{epoch}:%{version}-%{release}
...
Xorg-libs ÓÏÄÅÒÖÉÔ ÒÁÚÄÅÌÑÅÍÙÅ ÂÉÂÌÉÏÔÅËÉ, ËÏÔÏÒÙÅ ÎÅÏÂÈÏÄÉÍÙ ÄÌÑ
...
ÕÓÔÁÎÏ×ÉÔØ Xorg-libs. ôÁËÖÅ ÎÅÏÂÈÏÄÉÍÏ ÕÓÔÁÎÏ×ÉÔØ ÓÌÅÄÕÀÝÉÅ ÐÁËÅÔÙ:
Xorg, ÏÄÉÎ ÉÌÉ ÎÅÓËÏÌØËÏ ÐÁËÅÔÏ× ÛÒÉÆÔÏ× Xorg, Xconfigurator,
Xorg-xfs.

åÓÌÉ ×Ù ÓÏÂÉÒÁÅÔÅÓØ ÒÁÚÒÁÂÁÔÙ×ÁÔØ ÐÒÏÇÒÁÍÍÙ, ÒÁÂÏÔÁÀÝÉÅ ËÁË X-ËÌÉÅÎÔÙ,
×ÁÍ ÔÁËÖÅ ÎÁÄÏ ÕÓÔÁÎÏ×ÉÔØ Xorg-devel.

%description libs -l uk
Xorg-libs Í¦ÓÔÉÔØ Â¦ÂÌ¦ÏÔÅËÉ ÓÐ¦ÌØÎÏÇÏ ×ÉËÏÒÉÓÔÁÎÎÑ, ËÏÔÒ¦
ÎÅÏÂÈ¦ÄÎ¦ ÄÌÑ ÒÏÂÏÔÉ Â¦ÌØÛÏÓÔ¦ ÐÒÉËÌÁÄÎÉÈ ÐÒÏÇÒÁÍ ÄÌÑ X. ã¦ Â¦ÂÌ¦ÏÔÅËÉ
×ÉÎÅÓÅÎ¦ × ÏËÒÅÍÉÊ ÐÁËÅÔ ÄÌÑ ÅËÏÎÏÍ¦§ ÄÉÓËÏ×ÏÇÏ ÐÒÏÓÔÏÒÕ, ÎÅÏÂÈ¦ÄÎÏÇÏ
...
×ÓÔÁÎÏ×ÉÔÉ Xorg-libs. ôÁËÏÖ ÎÅÏÂÈ¦ÄÎÏ ×ÓÔÁÎÏ×ÉÔÉ ÔÁË¦ ÐÁËÅÔÉ:
Xorg, ÏÄÉÎ ÁÂÏ ÄÅË¦ÌØËÁ ÐÁËÅÔ¦× ÛÒÉÆÔ¦× Xorg, Xconfigurator,
Xorg-xfs.

ñËÝÏ ×É ÚÂÉÒÁ¤ÔÅÓØ ÒÏÚÒÏÂÌÑÔÉ ÐÒÏÇÒÁÍÉ, ÑË¦ ÐÒÁÃÀÀÔØ ÑË X-ËÌ¦¤ÎÔÉ, ×ÁÍ
ÔÁËÏÖ ÎÅÏÂÈ¦ÄÎÏ ×ÓÔÁÎÏ×ÉÔÉ Xorg-devel.
...
Summary(ru):	õÔÉÌÉÔÁ ÄÌÑ ËÏÎÆÉÇÕÒÁÃÉÉ Xorg
Summary(uk):	õÔÉÌ¦ÔÁ ÄÌÑ ËÏÎÆ¦ÇÕÒÕ×ÁÎÎÑ Xorg
Group:		X11/Xorg
Requires:	%{name}-Xserver = %{epoch}:%{version}-%{release}
...
Pakiet setup zawiera narzêdzia do konfiguracji Xorg. Pozwala na
...
õÔÉÌÉÔÁ ÄÌÑ ËÏÎÆÉÇÕÒÁÃÉÉ Xorg.

%description setup -l uk
õÔÉÌ¦ÔÁ ÄÌÑ ËÏÎÆ¦ÇÕÒÕ×ÁÎÎÑ Xorg.
...
Xorg-static ×ËÌÀÞÁÅÔ ÓÔÁÔÉÞÅÓËÉÅ ÂÉÂÌÉÏÔÅËÉ, ÎÅÏÂÈÏÄÉÍÙÅ ÄÌÑ
ÒÁÚÒÁÂÏÔËÉ ÐÒÏÇÒÁÍÍ, ÒÁÂÏÔÁÀÝÉÈ ËÁË X-ËÌÉÅÎÔÙ. ÓÏÂÒÁÎÎÙÅ ÐÒÏÇÒÁÍÍÙ,
ËÏÔÏÒÙÅ ÂÕÄÕÔ ÒÁÂÏÔÁÔØ ËÁË X-ËÌÉÅÎÔÙ.

%description static -l uk
Xorg-static Í¦ÓÔÉÔØ ÓÔÁÔÉÞÎ¦ Â¦ÂÌ¦ÏÔÅËÉ, ÎÅÏÂÈ¦ÄÎ¦ ÄÌÑ ÒÏÚÒÏÂËÉ
ÐÒÏÇÒÁÍ, ÑË¦ ÐÒÁÃÀÀÔØ ÑË X-ËÌ¦¤ÎÔÉ.

%package tools
Summary:	Various tools for Xorg
Summary(pl):	Ró¿ne narzêdzia dla Xorg
Summary(ru):	òÁÚÎÏÏÂÒÁÚÎÙÅ ÕÔÉÌÉÔÙ ÄÌÑ Xorg
Summary(uk):	ò¦ÚÎÏÍÁÎ¦ÔÎ¦ ÕÔÉÌ¦ÔÉ ÄÌÑ Xorg
Group:		X11/Xorg
...
Je¶li u¿ywasz Xów powiniene¶ zainstalowaæ Xorg-tools. Bêdziesz
równie¿ musia³ zainstalowaæ pakiet Xorg, pakiet odpowiadaj±cy
...
klienci X, bêdziesz musia³ zainstalowaæ równie¿ Xorg-devel.
...
Xorg-tools. ôÁËÖÅ ×ÁÍ ÔÁËÖÅ ÎÅÏÂÈÏÄÉÍÏ ÕÓÔÁÎÏ×ÉÔØ ÔÁËÉÅ ÐÁËÅÔÙ:
Xorg, Xconfigurator, Xorg-xfs É Xorg-libs. ÷ÏÚÍÏÖÎÏ, ×ÁÍ ÎÁÄÏ
ÕÓÔÁÎÏ×ÉÔØ É ÄÒÕÇÉÅ ÐÁËÅÔÙ ÛÒÉÆÔÏ× Xorg.
...
Xorg-tools. ôÁËÏÖ ÔÒÅÂÁ ×ÓÔÁÎÏ×ÉÔÉ ÔÁË¦ ÐÁËÅÔÉ: Xorg,
Xconfigurator, Xorg-xfs ÔÁ Xorg-libs. íÏÖÌÉ×Ï, ×ÁÍ ÔÒÅÂÁ
×ÓÔÁÎÏ×ÉÔÉ Ê ¦ÎÛ¦ ÐÁËÅÔÉ ÛÒÉÆÔ¦× Xorg.
...
Summary(pl):	Serwer fontów dla Xorg
...
Pakiet zawiera serwer fontów dla Xorg. Mo¿e udostêpniaæ fonty dla X
serwerów lokalnych lub zdalnych.

%description xfs -l ru
Xorg-xfs ÓÏÄÅÒÖÉÔ ÓÅÒ×ÅÒ ÛÒÉÆÔÏ× ÄÌÑ Xorg. Xfs ÔÁËÖÅ ÍÏÖÅÔ
...
÷Ù ÄÏÌÖÎÙ ÕÓÔÁÎÏ×ÉÔØ Xorg-xfs ÅÓÌÉ ×Ù ÕÓÔÁÎÁ×ÌÉ×ÁÅÔÅ X Window
System. ôÁËÖÅ ×ÁÍ ÐÒÉÄÅÔÓÑ ÕÓÔÁÎÏ×ÉÔØ ÓÌÅÄÕÀÝÉÅ ÐÁËÅÔÙ: Xorg,
ÐÁËÅÔ(Ù) ÛÒÉÆÔÏ× Xorg, ÎÅÏÂÈÏÄÉÍÙÅ ÄÌÑ ×ÁÛÅÊ ÓÉÓÔÅÍÙ, Xconfigurator
É Xorg-libs.

%description xfs -l uk
Xorg-xfs Í¦ÓÔÉÔØ ÓÅÒ×ÅÒ ÛÒÉÆÔ¦× ÄÌÑ Xorg. Xfs ÔÁËÏÖ ÍÏÖÅ
ÎÁÄÁ×ÁÔÉ ÛÒÉÆÔÉ ×¦ÄÄÁÌÅÎÉÍ X-ÓÅÒ×ÅÒÁÍ. ÷¦ÄÄÁÌÅÎÁ ÓÉÓÔÅÍÁ ÚÍÏÖÅ
×ÉËÏÒÉÓÔÏ×Õ×ÁÔÉ ÕÓ¦ ÛÒÉÆÔÉ, ÑË¦ ×ÓÔÁÎÏ×ÌÅÎ¦ ÎÁ ÓÅÒ×ÅÒ¦ ÛÒÉÆÔ¦×, ÎÁ×¦ÔØ
ÑËÝÏ ×ÏÎÉ ÎÅ ×ÓÔÁÎÏ×ÌÅÎ¦ ÎÁ ×¦ÄÄÁÌÅÎÏÍÕ ËÏÍÐ'ÀÔÅÒ¦.

÷É ÐÏ×ÉÎÎ¦ ×ÓÔÁÎÏ×ÉÔÉ Xorg-xfs ÑËÝÏ ×É ×ÓÔÁÎÏ×ÌÀ¤ÔÅ X Window
System. ôÁËÏÖ ×ÁÍ ÐÒÉÊÄÅÔØÓÑ ×ÓÔÁÎÏ×ÉÔÉ ÎÁÓÔÕÐÎ¦ ÐÁËÅÔÉ: Xorg,
ÐÁËÅÔ(É) ÛÒÉÆÔ¦× Xorg, ÎÅÏÂÈ¦ÄÎ¦ ÄÌÑ ×ÁÛÏ§ ÓÉÓÔÅÍÉ, Xconfigurator
ÔÁ Xorg-libs.
